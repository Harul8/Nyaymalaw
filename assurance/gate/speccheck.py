"""Specification integrity checks. PRD self-consistency, mechanically.
    ...
    python assurance/gate/speccheck.py
...
EVALS = ROOT / "assurance" / "specification" / "evals.yaml"
GOLDEN = ROOT / "docs" / "GOLDEN_SET.md"
GATES = ROOT / "assurance" / "specification" / "gates.yaml"
...
def main() -> int:
    rep = Report()
    subprocess.run([sys.executable, str(ROOT / "assurance" / "gate" / "export_spec.py")],
