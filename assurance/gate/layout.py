"""A LAYOUT CHECK THAT CANNOT BE SWITCHED OFF BY A STYLE RULE. BK-43, BK-47.
    ...
    from assurance.gate.layout import MEASURE_JS, WIDTHS, clipped, population_problems
...
the work sufficient -- the same silence `assurance/journeys/journey.py`'s EXPECTED manifest
