"""Mutation check: break the code on purpose, prove the test catches it.
    ...
    python assurance/gate/mutate.py
...
the evidence `assurance/gate/trace.py` needs for check T6. Running is not the same as
...
from assurance.control_plane.evidence import child_environment  # noqa: E402
