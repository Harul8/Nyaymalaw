"""The golden runner. Task T-005b, and the blocker on every slice.
    ...
    python assurance/journeys/run_goldens.py                      # structure + authority, FREE
    python assurance/journeys/run_goldens.py --suite smoke --approve   # actually run them
...
slice could close, and `assurance/gate/slicegate.py` reported the same blocker ten times
in a row.
