...
WHY
---
`assurance/journeys/run_goldens.py --suite full` died halfway through its own report:
...
tool's, and it was latent in all fourteen. `assurance/gate/check.py` runs most of them
