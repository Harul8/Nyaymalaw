"""Source identity for recorded runs. THE OWNER IS `backend/nm/domain/identity.py`.
...
Moving it into `backend/nm/` put the definition where both callers can reach it. Two
