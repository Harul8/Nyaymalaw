...
from assurance.control_plane import backlog, blueprint, evidence  # noqa: E402
from assurance.control_plane.blueprint_approvals import adoption_labels  # noqa: E402
from assurance.control_plane.readiness_plan import derive as derive_readiness  # noqa: E402
...
def main() -> int:
    paths = [
        ...
        "assurance/specification/prd/part_a.js", "assurance/specification/prd/part_b.js", "assurance/specification/prd/part_c.js",
        "assurance/specification/prd/build.js", "assurance/specification/prd/helpers.js", "assurance/specification/prd/schemas.js",
        "assurance/specification/prd/gates.json", "assurance/specification/features.yaml", "docs/Nyaymalaw_PRD.docx",
        "assurance/specification/plan/view_content.json", "assurance/specification/plan/build_current_plan.mjs",
        "assurance/specification/plan/export_current_plan.py", "assurance/specification/plan/README.md",
    ]
    ...
    doc["_snapshot"] = {
        ...
        "status_semantics": (
            ...
            "assurance.control_plane.backlog with current execution binding."
        ),
