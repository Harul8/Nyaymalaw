...
`assurance/control_plane/readiness_plan.py::derive` at export. "Recorded" counts results written in
...
`assurance/control_plane/backlog.py lint` refuses a journey step in no stage or two, stages out of
...
```text
<bundled-node> assurance/specification/plan/build_current_plan.mjs
