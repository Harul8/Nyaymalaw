...
|---|---|---:|---:|---:|---|
| A | Arrive | 3/4 | 6/24 | 5 | not releasable |
| B | Open a matter | 0/6 | 3/10 | 1 | not releasable |
| C | Take the brief | 5/7 | 5/15 | 3 | not releasable |
| D | Work the file | 8/9 | 8/23 | 3 | not releasable |
| E | Advise | 1/5 | 4/21 | 3 | not releasable |
| F | Act | 0/7 | 0/3 | 0 | not releasable |
| G | Carry | 0/3 | 1/5 | 0 | not releasable |
| H | Close | 0/2 | 0/2 | 0 | not releasable |
| I | Leave | 1/1 | 1/10 | 3 | not releasable |

**69 rows · 10 open P0 · 1 blocked · 18/44 features implemented**
...
- **42 active rows carry no acceptance criteria yet**, so `done` cannot be derived for them however much work is finished.
