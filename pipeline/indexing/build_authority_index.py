...
its own. `assurance/gate/check.py` stays cheap enough that there is never an excuse to
...
`backend/nm/knowledge/artefact.py` refuses one whose identity does not match.
"""
