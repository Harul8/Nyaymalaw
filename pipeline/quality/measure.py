"""THE COMMANDS THAT TAKE THE MEASUREMENTS THIS BUILD CANNOT TAKE.
    ...
    python pipeline/quality/measure.py seal
    python pipeline/quality/measure.py production --criterion BK-42-AC3 --environment ...
    python pipeline/quality/measure.py production-record --file <signed.json>
    python pipeline/quality/measure.py review-pack --criterion BK-42-AC9
    python pipeline/quality/measure.py review-record --file <signed.json>
    python pipeline/quality/measure.py tabletop-pack
    python pipeline/quality/measure.py tabletop-record --file <exercise.json>
...
from assurance.control_plane.evidence_verification import configured_verifier  # noqa: E402
from assurance.control_plane.structured_evidence import problems_for_record  # noqa: E402
...
def production(args) -> int:
    ...
    print("    python pipeline/quality/measure.py production-record --file <signed-record.json>")
    return 0
...
def review_pack(args) -> int:
    ...
    print("    python pipeline/quality/measure.py review-record --file <signed.json>")
    return 0
...
def tabletop_pack(args) -> int:
    ...
    print("    python pipeline/quality/measure.py tabletop-record --file <exercise.json>")
    return 0
