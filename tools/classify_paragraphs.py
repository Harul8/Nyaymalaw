"""Classify judgment paragraphs, and MEASURE THAT BEFORE INGESTING ANYTHING.
    ...
    python tools/classify_paragraphs.py --eval --sample 200   # measure first
    python tools/classify_paragraphs.py --plan                # what a run costs
    python tools/classify_paragraphs.py --run                 # classify staging
