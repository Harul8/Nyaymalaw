...
def check(document: dict, decisions: dict, approvals: dict | None) -> list[str]:
    ...
    if not isinstance(signoff, dict):
        ...
        if (
            ...
            or signoff.get("target") != "docs/backlog/evidence/BK-85-AC3.json"
        ):
            errors.append(
...
def render(document: dict) -> str:
    ...
    lines = [
        "<!-- GENERATED by tools/india_applicability.py; edit india_applicability_review.json -->",
...
def evidence_template(document: dict) -> dict:
    ...
    return {
        ...
        "record": {
            ...
            "method": None,
            "actor": None,
            "authority": {"basis": None, "evidence": {"ref": None, "sha256": None}},
            "rubric": None,
            "population": {"count": None, "described": None},
            "reservations": None,
            "observed_at": None,
            "subject_identity": {"kind": "external", "valid_until": None},
        },
        "instructions": signoff["signing_instruction"],
    }
...
def main() -> int:
    ...
    from tools.blueprint import load_contracts
