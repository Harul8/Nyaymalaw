...
*Evidence:* `backend/nm/knowledge/authority.py - a citation carries binding or persuasive RELATIVE to the forum asking, and the year is part of the computation rather than a tiebreak`
...
*Evidence:* `backend/nm/core/queue.py - build_queue ranks; nothing removes a thread from the file, so a sub-issue cannot be discarded by a pattern that failed to recognise it`
...
*Evidence:* `backend/nm/core/queue.py::GapQueue.plan - every thread is accounted for; a deferral is a stated outcome, so nothing is capped away silently`
...
**P1** · *fixed* · `backend/nm/tools/layercheck` · found by: code review · area: F-02

A relative import CAN cross a layer: from backend/nm/core/x.py, `from ..adapters.store import Store` resolves to nm.adapters.store. The checker skipped all relative imports, so the main Phase 0 boundary was bypassable while reporting clean.
...
**P2** · *fixed* · `backend/nm/tools/layercheck` · found by: code review · area: F-02

The fix claimed `from ...agents.posture` in backend/nm/core reaches the legacy tree. Measured against CPython's _resolve_name, that is an ImportError — a relative import climbs to the top-level package at most, so it can never leave backend/nm/. A wrong threat model aims future work at the wrong thing.
...
**P2** · *fixed* · `backend/nm/core/answer` · found by: code review · area: D-01
...
**P2** · *fixed* · `backend/nm/core/errors` · found by: code review · area: F-10
...
**P1** · *fixed* · `backend/nm/core/errors` · found by: code review · area: F-10
...
**P2** · *fixed* · `backend/nm/tools/plan_update` · found by: code review · area: F-09; logic extracted to backend/nm/tools/rollup.py so it is class-A testable
...
**P3** · *fixed* · `backend/nm/tools/exceptcheck` · found by: self-check · area: F-10
...
**P3** · *fixed* · `backend/nm/obs/metrics` · found by: self-check · area: F-10
...
**P2** · *fixed* · `backend/nm/knowledge/manifest.json` · found by: self-check · area: M-02 key corrected
...
*Evidence:* `backend/nm/knowledge/subject.py::collisions reports; which copy is better varies per Act, so a merge is a decision with evidence rather than a sweep that destroys real law`
...
*Evidence:* `backend/nm/tests/a_logic/test_correspondence.py - the era question is answered from the savings text, and refused rather than guessed where there is none`
...
*Evidence:* `backend/nm/tests/a_logic/test_interprets.py - a reference the graph cannot resolve is a CANDIDATE, not an edge and not silence`

### B-52 — The build report disagreed with the graph it described

**P2** · *fixed* · `backend/nm/knowledge/graph_build.py` · found by: self-check · area: counts derived from the graph; invariant test added
...
*Evidence:* `backend/nm/tests/c_corpus/test_ingest_corpus.py::test_no_act_holds_a_numbering_gap_wider_than_its_own_section_count, test_an_act_holding_one_provision_makes_no_claim_about_holes`
...
**P1** · *fixed* · `backend/nm/knowledge/observe.py` · found by: self-check · area: M-03 extended; class-A and class-C invariants added
...
*Evidence:* `test_the_same_source_yields_the_same_provisions; backend/nm/tests/c_corpus/test_ingest_corpus.py::test_re_running_ingestion_over_the_same_source_changes_nothing - re-running cannot accumulate a second copy`

### B-59 — A procedural code's Orders are read as a listing, not as the code

**P2** · *fixed* · `backend/nm/knowledge/ingest.py` · found by: I-01 ingestion · area: I-01 / the run-restart rule in _real_scopes
...
**P1** · *fixed* · `backend/nm/knowledge/citations.py` · found by: C-04 gold set draw · area: backend/nm/knowledge/citations.py::_window and CitationMention.__post_init__
...
**P1** · *fixed* · `backend/nm/knowledge/judgments.py` · found by: C-04 gold set draw · area: backend/nm/knowledge/judgments.py::_ascending_run
...
**P2** · *fixed* · `backend/nm/knowledge/judgments.py` · found by: C-04 gold set draw · area: I-02 / _ascending_run does not pay a marker for what it swallowed
...
**P2** · *fixed* · `backend/nm/core/analysis.py` · found by: Phase 3 review · area: backend/nm/core/analysis.py::_SECOND_SENTENCE
...
**P2** · *fixed* · `backend/nm/edge/phase3.py` · found by: Phase 3 review · area: backend/nm/edge/phase3.py::assert_conclusions_rest_on_usable_facts
...
**P3** · *fixed* · `backend/nm/edge/phase3.py` · found by: Phase 3 review · area: backend/nm/edge/phase3.py::assert_proof
...
**P2** · *fixed* · `backend/nm/core/answer.py` · found by: Phase 3 review · area: backend/nm/core/answer.py::Deadline
...
**P2** · *fixed* · `backend/nm/core/answer.py` · found by: Phase 4 build · area: backend/nm/core/answer.py::Answer, story AN-05
...
**P2** · *fixed* · `backend/nm/core/summary.py` · found by: Phase 4 build · area: backend/nm/core/summary.py::internal_ids, story AN-10
...
**P3** · *fixed* · `backend/nm/tests/a_logic/test_layering.py` · found by: Phase 5 build · area: backend/nm/tests/a_logic/test_layering.py, story DF-03
...
**P1** · *fixed* · `infra/crypto.py` · found by: Phase 6 legacy read · area: EN-05 / backend/nm/adapters/crypto.py
...
**P2** · *fixed* · `backend/nm/tools/copycheck.py` · found by: Phase 6 build · area: EN-26
...
**P1** · *fixed* · `backend/nm/core/assembly.py` · found by: Phase 4/5 review · area: AN-03
...
**P1** · *fixed* · `backend/nm/drafting/verify.py` · found by: Phase 4/5 review · area: DF-06 / DF-08
...
**P1** · *fixed* · `backend/nm/core/brief.py` · found by: Phase 4/5 review · area: DF-02
...
**P1** · *fixed* · `backend/nm/drafting/agent.py` · found by: Phase 4/5 review · area: DF-03 (status downgraded to built)
...
**P1** · *fixed* · `backend/nm/drafting/agent.py` · found by: Phase 4/5 review · area: DF-03
...
**P2** · *fixed* · `backend/nm/core/assembly.py` · found by: Phase 4/5 review · area: AN-02
...
**P2** · *fixed* · `backend/nm/obs/length.py` · found by: Phase 4/5 review · area: AN-06

scales_with_content returned True when the sample could not separate content from turn number - the same 'could not run means pass' shape that backend/nm/drafting/verify.py rejects three modules away, and that the legacy draft verifier shipped (B-72). Now three-valued, with a strict `holds` for gate use. Worth recording because the same build got this right and wrong simultaneously: a rule stated in one module is not a rule applied in the next.
...
**P1** · *fixed* · `backend/nm/core/turn.py` · found by: Phase 7 wiring · area: IN-04
...
**P2** · *fixed* · `backend/nm/edge/session.py` · found by: Phase 7 wiring · area: IN-08 / AN-09
...
**P1** · *fixed* · `backend/nm/edge/export.py` · found by: Phase 6 review · area: EN-12 / AN-08
...
**P1** · *fixed* · `backend/nm/core/identity.py` · found by: Phase 6 review · area: EN-02
...
**P1** · *fixed* · `backend/nm/obs/approval.py` · found by: Phase 6 review · area: EN-24
...
**P1** · *fixed* · `backend/nm/obs/privacy.py` · found by: Phase 6 review · area: EN-10
...
**P1** · *fixed* · `backend/nm/core/audit.py` · found by: Phase 6 review · area: EN-11
...
**P1** · *fixed* · `backend/nm/obs/cost.py` · found by: Phase 6 review · area: EN-21
...
**P1** · *fixed* · `backend/nm/tools/release.py` · found by: Phase 6 review · area: EN-25
...
**P2** · *fixed* · `backend/nm/core/retention.py` · found by: Phase 6 review · area: EN-06
...
**P2** · *fixed* · `backend/nm/edge/phase6.py` · found by: Phase 6 review · area: IN-08 / EN-02..EN-13
...
**P1** · *fixed* · `backend/nm/edge/phase4.py + phase6.py` · found by: Phase 6 review · area: EN-10
...
**P1** · *fixed* · `backend/nm/core/advocate.py::URGENCY` · found by: AB-06 live run · area: AB-06
...
**P1** · *fixed* · `backend/nm/app/consult.py` · found by: AB-06 live run · area: AB-06
...
**P1** · *fixed* · `backend/nm/app/consult.py::_limitation` · found by: AB-16/17 live run · area: AB-16 / ADR-1
...
**P1** · *fixed* · `backend/nm/evidence/provider.py` · found by: AB-16/17 live run · area: AB-16 / ADR-1
...
**P1** · *fixed* · `backend/nm/app/consult.py::_gaps_for` · found by: AB-15 live run · area: AB-15
...
**P2** · *fixed* · `backend/nm/app/consult.py` · found by: AB-15 build · area: AB-15
...
*Evidence:* `backend/nm/app/consult.py::_board; backend/nm/app/ui.html renders a dash rather than an open circle`

### B-102 — nm could not tell the advocate when it was working outside its curated causes

**P2** · *fixed* · `backend/nm/app/consult.py::_board` · found by: AB-15 build · area: AB-15
...
**P1** · *fixed* · `backend/nm/obs/metrics.py` · found by: served turn · area: IN-08
...
**P1** · *fixed* · `backend/nm/core/gateway.py` · found by: served turn · area: IN-02 / D2B
...
**P1** · *fixed* · `backend/nm/app/consult.py` · found by: served turn · area: AB-09 / IN-09
...
**P1** · *fixed* · `backend/nm/app/state.py` · found by: served turn · area: AB-27 / CS2
...
**P1** · *fixed* · `backend/nm/eval` · found by: Phase 8 purge · area: E1 / build guide rule 1
...
*Evidence:* `backend/nm/eval/ - controlling_provision.jsonl (18), citation_drift_gold.jsonl (80), and six more`

### B-108 — Five functions carrying the new behaviour had no tests

**P2** · *fixed* · `backend/nm/app/consult.py` · found by: code graph · area: AB-06 / E3
...
*Evidence:* `backend/nm/tests/a_logic/test_urgency.py - five tests added`

### B-109 — The answer handed the advocate a placeholder instead of a deadline

**P2** · *fixed* · `backend/nm/core/advocate.py::ADVOCATE` · found by: AB-01 live run · area: AB-01 / D16.19
...
**P1** · *fixed* · `backend/nm/app/analysis.py::_capabilities_block` · found by: AB-02 live run · area: AB-02 / D16.2
...
**P1** · *fixed* · `backend/nm/app/analysis.py::_capability_at_head` · found by: AB-02 live run · area: AB-02 / D16.2
...
**P2** · *fixed* · `backend/nm/app/analysis.py::_requirement_name` · found by: AB-02 live run · area: AB-02 / D16.2
...
**P2** · *fixed* · `backend/nm/core/competence.py::MEANING` · found by: AB-02 live run · area: AB-02 / D16.2
...
**P1** · *fixed* · `backend/nm/core/competence.py::Capability.nm_must_hold` · found by: AB-02 live run · area: AB-02 / D16.2
...
**P1** · *fixed* · `backend/nm/app/analysis.py::_answer_skeleton` · found by: AB-02 live run · area: AB-02 / D16.2
...
**P2** · *fixed* · `backend/nm/core/disagreement.py::Disagreement.line` · found by: AB-21 live run · area: AB-21 / D16.21
...
**P2** · *fixed* · `backend/nm/app/analysis.py::_unquote` · found by: AB-21 live run · area: AB-21 / D16.21
...
**P2** · *fixed* · `backend/nm/app/analysis.py::run_account` · found by: AB-07 live run · area: AB-07 / D16.7
...
**P1** · *fixed* · `backend/nm/core/interview.py::is_quoted_from` · found by: AB-07 live run · area: AB-07 / D16.7
...
**P1** · *fixed* · `backend/nm/core/objectives.py::Constraint` · found by: AB-08 live run · area: AB-08 / D16.8
...
**P1** · *fixed* · `backend/nm/app/analysis.py::_rests_on_the_account` · found by: AB-08 live run · area: AB-08 / D16.8
...
**P2** · *fixed* · `backend/nm/core/advocate.py::OBJECTIVES` · found by: AB-08 live run · area: AB-08 / D16.8
...
**P1** · *fixed* · `backend/nm/core/advocate.py::ACCOUNT` · found by: AB-07 live run · area: AB-07 / D16.7
...
**P1** · *fixed* · `backend/nm/app/consult.py::run` · found by: Phase 8 external review · area: AB-01 / D16.1
...
**P1** · *fixed* · `backend/nm/core/competence.py::over` · found by: Phase 8 external review · area: AB-02 / D16.2
...
**P1** · *fixed* · `backend/nm/core/competence.py::Assessment.referrals` · found by: Phase 8 external review · area: AB-02 / D16.2
...
**P1** · *fixed* · `backend/nm/app/consult.py::_thread_state` · found by: Phase 8 external review · area: AB-15 / D16.15
...
**P1** · *open* · `backend/nm/app/state.py::Conversation` · found by: Phase 8 external review · area: AB-03 / D16.3
...
**P2** · *fixed* · `backend/nm/core/decision.py` · found by: Phase 8 external review · area: AB-20 / D16.20
...
**P2** · *fixed* · `backend/nm/app/analysis.py::run_disagreement` · found by: Phase 8 external review · area: AB-21 / D16.21
...
**P1** · *fixed* · `backend/nm/adapters/inprocess.py::ScriptedModel` · found by: Phase 8 bar work · area: AB-01 / D16.1
...
**P1** · *fixed* · `backend/nm/tests/a_logic/test_served_api.py` · found by: Phase 8 bar work · area: AB-01 / D16.1
...
**P1** · *fixed* · `backend/nm/tests/a_logic/conftest.py` · found by: Phase 8 bar work · area: F-03
...
**P1** · *fixed* · `backend/nm/app/state.py::_open_backing` · found by: self-review after the persistence commit · area: AB-03 / EN-02 / B-74
...
**P1** · *fixed* · `backend/nm/app/consult.py::run` · found by: Phase 8 second review · area: AB-01 / D16.1
...
**P1** · *fixed* · `backend/nm/app/consult.py::UNSCREENED_NOTICE` · found by: Phase 8 second review · area: AB-01 / D16.1
...
**P2** · *fixed* · `backend/nm/core/competence.py::release` · found by: Phase 8 second review · area: AB-02 / D16.2
...
**P1** · *fixed* · `backend/nm/app/persistence.py::NESTED_SKIPPED` · found by: Phase 8 second review · area: AB-02 / EN-02
...
**P1** · *fixed* · `backend/nm/tests/a_logic/test_served_api.py` · found by: Phase 8 second review · area: AB-21 / D16.21
...
**P2** · *open* · `backend/nm/core/duty.py::Breach` · found by: Phase 8 second review · area: AB-01 / D16.1
...
**P2** · *open* · `backend/nm/app/consult.py::DECLARED` · found by: Phase 8 second review · area: AB-02 / D16.2
...
**P1** · *fixed* · `backend/nm/app/state.py::Conversations.all` · found by: self-review before claiming AB-03 · area: AB-03 / D16.3
...
**P2** · *fixed* · `backend/nm/app/conflicts.py::screening_note` · found by: self-review before claiming AB-03 · area: AB-03 / D16.3
...
**P1** · *fixed* · `backend/nm/app/consult.py` · found by: self-review before claiming AB-06 · area: AB-06 / D16.6
...
**P1** · *fixed* · `backend/nm/core/urgency.py::carry_forward` · found by: self-review before claiming AB-06 · area: AB-06 / D16.6
...
**P1** · *fixed* · `backend/nm/app/triage.py::run` · found by: self-review before claiming AB-06 · area: AB-06 / D16.6
...
**P1** · *fixed* · `backend/nm/app/consult.py::_urgent_lead` · found by: self-review before claiming AB-06 · area: AB-06 / D16.6
...
**P2** · *fixed* · `backend/nm/core/urgency.py::resolve` · found by: self-review before claiming AB-06 · area: AB-06 / D16.6
...
**P1** · *fixed* · `backend/nm/core/engagement.py::Engagement` · found by: self-review before claiming AB-04 · area: AB-04 / D16.4
...
**P1** · *fixed* · `backend/nm/core/engagement.py::reliance` · found by: self-review before claiming AB-04 · area: AB-04 / D16.4
...
**P1** · *fixed* · `backend/nm/app/server.py` · found by: self-review before claiming AB-04 · area: AB-04 / D16.4
...
**P1** · *fixed* · `backend/nm/core/urgency.py::Triage` · found by: Phase 8 third review · area: AB-06 / D16.6
...
**P1** · *fixed* · `backend/nm/app/consult.py` · found by: Phase 8 third review · area: AB-06 / D16.6
...
**P1** · *fixed* · `backend/nm/app/conflicts.py::check` · found by: Phase 8 third review · area: AB-03 / D16.3
...
**P1** · *fixed* · `backend/nm/core/readiness.py` · found by: Phase 8 third review · area: AB-01 / D16.1
...
**P1** · *fixed* · `backend/nm/app/analysis.py::screen_urgency_actions` · found by: Phase 8 third review · area: AB-01 / AB-06
...
**P2** · *fixed* · `backend/nm/core/urgency.py::carry_forward` · found by: Phase 8 third review · area: AB-06 / D16.6
...
**P1** · *fixed* · `backend/nm/app/consult.py` · found by: nm.tools.probe, first run · area: AB-03 / AB-02 / readiness
...
**P1** · *open* · `backend/nm/app/intake.py` · found by: nm.tools.matrix, first run · area: AB-06 / intake
...
**P2** · *open* · `backend/nm/app/consult.py` · found by: nm.tools.matrix, first run · area: AB-01 / consult exits
...
**P2** · *open* · `backend/nm/knowledge (to verify)` · found by: corpus survey for golden scenarios · area: retrieval / D9A coverage
