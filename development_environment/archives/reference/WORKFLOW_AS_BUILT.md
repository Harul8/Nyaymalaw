...
`backend/nm/app/consult.py::run` and the modules it calls. Where this document says
...
AB-23 is `Not implemented`. There is a `backend/nm/drafting` layer with a signature
