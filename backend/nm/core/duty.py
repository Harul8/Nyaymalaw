...
SYSTEM = (
    ...
    "Distinguish an instruction to perform prohibited conduct from legitimate "
    "analysis of conduct, consequences or an opposing allegation. Refuse only "
    "a supported prohibited instruction, not the topic, vocabulary or adversity.\n\n"
