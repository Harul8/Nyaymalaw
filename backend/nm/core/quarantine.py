...
THIS MODULE DELIBERATELY DOES NOT NAME THAT GATE'S ID. `assurance/gate/trace.py` T9
fails the build when a gate declared unbuilt is consulted anywhere in `backend/nm/`,
