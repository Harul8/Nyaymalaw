...
NOT `backend/nm/core/intake.py`, WHICH IS C6 AND ABOUT DOCUMENTS. That module reads
...
SYSTEM = (
    ...
    "A PARTY IS A PERSON OR AN ENTITY, not a procedural role, document or "
    "object. Do not turn an unnamed role into an identified person.\n\n"
    ...
    "Include named related persons and entities relevant to the matter and "
    "conflict check, with their attributed relationship. Do not import persons "
    "mentioned only in quoted legal authorities as parties to this matter.\n\n"
