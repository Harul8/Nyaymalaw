...
#: from `backend/nm/domain/gates.py` fails at the call rather than quietly recording a
...
GATE_FOR: dict[ScreenKind, tuple[str, dict[ScreenState, str]]] = {
    ...
    # `backend/nm/domain/gates.py` declares each gate's states and is not P14's to
