...
So the measurement now has one home and two consumers:
    ...
    pipeline/quality/releasegate.py  measures ------> assurance/specification/coverage.yaml
                                              |
...
--------------------------------
`MET` and `UNMET` are not enough. If `assurance/specification/coverage.yaml` has never been
