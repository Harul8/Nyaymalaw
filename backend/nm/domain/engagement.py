...
#: what this list promised above. `backend/nm/domain/commission.py` now holds who
...
#: and `backend/nm/domain/authority.py` records who may give an instruction without
