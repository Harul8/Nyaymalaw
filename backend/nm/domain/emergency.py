...
----------------------------------------
`backend/nm/core/screens.may_admit_substance` already takes `emergency: bool`, and a
...
`backend/nm/core/screens.py` already uses, kept deliberately because this module is
