...
The MEASUREMENT lives in `backend/nm/knowledge/coverage.py` (it reads a file) and the
GATE lives in `backend/nm/core/turn.py` (it must stay pure). Neither may import the
