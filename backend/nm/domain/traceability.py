...
purpose is to make `assurance/gate/trace.py` able to answer, mechanically, three
...
def refuses(feature_id: str, never_index: int) -> Callable[[F], F]:
    ...
    `never` list in assurance/specification/features.yaml. The NEVER half of the contract is the
