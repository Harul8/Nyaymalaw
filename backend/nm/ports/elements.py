...
THE TABLE IS NOT HERE. `backend/nm/knowledge/elements.py` holds the curated element
lists and `backend/nm/adapters/knowledge/elements.py` serves them through this port.
