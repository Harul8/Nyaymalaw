...
from a record that already owns it:
    ...
    the objective, the instruction, who decides   nm/domain/commission.py
    who may concede, and on whose authority       nm/domain/authority.py
    theory, reliefs, propositions, locators       nm/domain/drafting.py (P29)
    the witness and expert packs                  nm/domain/witness.py (P31)
...
-------------------------------------------------------
`nm/domain/authority.py` already owns `permits(actor, capacity, Act.CONCEDE)`
and `nm/domain/commission.py` already keeps the instructing party and the
